...
console.log(caught_speeding(60, false)) // should return 0
console.log(caught_speeding(65, false)) // should return 1
console.log(caught_speeding(65, true)) // should return
// BONUS: MAKE BRICKS
//
...
console.log(makeBricks(3, 1, 8));  // should return true
console.log(makeBricks(3, 1, 9));  // should return false
console.log(makeBricks(3, 2, 10)); // should return true
